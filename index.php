...
<html class="no-js" lang="en">
    ...
    <body>
        ...
        <div id="start">
 <div class="startSlideshow" style="display:none;">

                <img class="slidestart" src="css/assets/start-1.png"/>
                <img class="slidestart" src="css/assets/start-2.png"/>
        ...
        <div id="finishedShopping">
            ...
            <img id="goodflight" style="display:none" src="css/assets/have-a-good-flight.png"/>
        </div>
